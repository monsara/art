...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('input[name="name"]');
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('input[name="message"]');
...
var filter = function filter() {
  ...
  menu.addEventListener('click', function (e) {
    ...
    function bindBtnTypeClick(btn) {
      var className = ".".concat(btn.classList[0]);
      var portfolioContainer = btn.closest('.portfolio');
      var type = portfolioContainer.querySelectorAll(".portfolio-block".concat(className));
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  var btn = document.querySelector(trigger); // #region Open version with simple upload styles
  // cards.forEach(card => {
  ...
  btn.addEventListener('click', function () {
    ...
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResource"])('assets/db.json') // .then(res => createCards(res))
    .then(function (res) {
